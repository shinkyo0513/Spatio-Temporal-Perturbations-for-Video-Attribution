...
# CUDA_VISIBLE_DEVICES=1 python evaluation/main_causal_metric.py --dataset ucf101 --model r2p1d --vis_method sg2
# CUDA_VISIBLE_DEVICES=1 python evaluation/main_causal_metric.py --dataset ucf101 --model r2p1d --vis_method grad_cam
# CUDA_VISIBLE_DEVICES=3 python evaluation/main_causal_metric.py --dataset ucf101 --model r2p1d --vis_method perturb
