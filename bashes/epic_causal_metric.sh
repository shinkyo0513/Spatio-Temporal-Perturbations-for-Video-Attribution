...
CUDA_VISIBLE_DEVICES=8 python evaluation/main_causal_metric.py --dataset epic --model r2p1d --vis_method perturb --extra_label _core5 --only_test 
...
# CUDA_VISIBLE_DEVICES=8 python evaluation/main_causal_metric.py --dataset epic --model r50l --vis_method perturb --extra_label _core5 --only_test 