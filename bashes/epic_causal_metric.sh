...
# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r2p1d --vis_method random --mode ins --num_step 128
# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r2p1d --vis_method random --mode ins --num_step 128 --new_size 16

# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r2p1d --vis_method random --mode del --num_step 128
# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r2p1d --vis_method random --mode del --num_step 128 --new_size 16

# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r50l --vis_method random --mode ins --num_step 128
# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r50l --vis_method random --mode ins --num_step 128 --new_size 16

# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r50l --vis_method random --mode del --num_step 128
# CUDA_VISIBLE_DEVICES=0 python evaluation/main_causal_metric.py --dataset epic --model r50l --vis_method random --mode del --num_step 128 --new_size 16