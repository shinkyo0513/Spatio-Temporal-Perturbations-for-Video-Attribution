...
# CUDA_VISIBLE_DEVICES=5 python evaluation/main_causal_metric.py --dataset ucf101 --model r2p1d --vis_method blur_ig --mode ins --order most_first --num_step 128 --batch_size 30 --only_test
...
CUDA_VISIBLE_DEVICES=5 python evaluation/main_causal_metric.py --dataset ucf101 --model r2p1d --vis_method blur_ig --mode ins --order most_first --num_step 128 --batch_size 30 --new_size 16 --only_test
