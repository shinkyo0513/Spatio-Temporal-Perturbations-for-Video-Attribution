...
#$ -l rt_F=1
#$ -l h_rt=10:00:00
#$ -o outs_sthsthv2/tsm_ins_morf_perturb3.txt
#$ -j y
#$ -cwd
...
# python process_perturb_res.py --dataset sthsthv2 --model tsm --only_test --extra_label _core11
...
# python process_perturb_res.py --dataset sthsthv2 --model tsm --only_test --extra_label _core11_cylinder

# python evaluation/main_causal_metric.py --dataset sthsthv2 --model tsm \
# --vis_method perturb --mode ins --order most_first --num_step 128 --batch_size 48 \
# --multi_gpu --new_size 16 --extra_label _core11_cylinder --only_test

# python process_perturb_res.py --dataset sthsthv2 --model tsm --only_test --extra_label _core14

# python evaluation/main_causal_metric.py --dataset sthsthv2 --model tsm \
# --vis_method perturb --mode ins --order most_first --num_step 128 --batch_size 48 \
# --multi_gpu --new_size 16 --extra_label _core14 --only_test

# python process_perturb_res.py --dataset sthsthv2 --model tsm --only_test --extra_label _core14_cylinder

# python evaluation/main_causal_metric.py --dataset sthsthv2 --model tsm \
# --vis_method perturb --mode ins --order most_first --num_step 128 --batch_size 48 \
# --multi_gpu --new_size 16 --extra_label _core14_cylinder --only_test
