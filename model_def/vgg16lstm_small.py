...
class vgg16lstm (nn.Module):
    def __init__ (self, num_classes, with_softmax=False, pretrained=True):
        ...
        if pretrained:
            self.load_weights(f"{proj_root}/model_param/ucf101_24_vgg16lstm.pt")
    ...
    def load_weights_from_caffemodel (self, save=False):
        import caffe
        caffe_root = f'{proj_root}/Caffe-ExcitationBP-RNNs-master'
        ...
        if save:
            save_dir = f"{proj_root}/models/ucf101_24_vgg16lstm.pt"
...
if __name__ == "__main__":
    ...
    pt_save_dir = f"{proj_root}/model_param/ucf101_24_vgg16lstm.pt"
    num_f = 8
    long_range = True
